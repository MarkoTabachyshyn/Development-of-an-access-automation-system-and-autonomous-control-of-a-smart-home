...
const char* mqtt_user = "esp325";
const char* mqtt_password = "555";
const char* mqtt_topic_publish = "home/room/livingroom";
const char* mqtt_topic_subscribe = "home/room/livingroom";
...
void reconnect() {
  while (!client.connected()) {
    ...
    if (client.connect("ESP32_LivingRoom", mqtt_user, mqtt_password)) {
